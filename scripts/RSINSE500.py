...
INPUT_CSV   = os.path.join(BASE_DIR, "stock_lists", "nse500list.csv")
OUTPUT_XLSX = os.path.join(BASE_DIR, "reports",     "NSE500_stocks.xlsx")
OUTPUT_JSON = os.path.join(BASE_DIR, "reports",     "NSE500_data.json")
...
def main():
    ...
    write_json(results, rsi_all, OUTPUT_JSON, "NSE 500")

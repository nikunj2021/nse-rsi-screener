...
INPUT_CSV   = os.path.join(BASE_DIR, "stock_lists", "micro250list.csv")
OUTPUT_XLSX = os.path.join(BASE_DIR, "reports",     "Micro250_stocks.xlsx")
OUTPUT_JSON = os.path.join(BASE_DIR, "reports",     "Micro250_data.json")
...
def main():
    ...
    write_json(results, rsi_all, OUTPUT_JSON, "Nifty Microcap 250")
